...
class BaseRobot():
    def __init__(self):
        ...
        self.drivebase.settings(straight_speed=settings.straight_speed, straight_acceleration=settings.straight_accel, turn_rate=settings.turn_rate, turn_acceleration=settings.turn_acceleration)
